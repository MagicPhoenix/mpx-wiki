...
Recommend to mount it at the Y endstop first, then leave a proper length to the toolhead and cut it.
...
You can use Zip Ties instead of the printed cable clip.
