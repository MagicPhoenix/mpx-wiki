...
8. Power Cord. 
9. Grease. Any lithium base grease would work. (Voron reccomends NLGI Grade 0 or 1.)
10. Threadlocker - Medium Strenngth (Blue) (For Pulley grub screws)
11. Tape Measure - For frame squaring.

## Reccomended addditional tools:
1. Multimeter
2. Crimpers for GH.125 connectors or pre crimped wires (Rapido thermistor wires need changed to fit the SB2209 if you ordered the Rapido Hotend)
3. Tweezers (For belt routing)
4. Machinist's Square (For frame squaring)
