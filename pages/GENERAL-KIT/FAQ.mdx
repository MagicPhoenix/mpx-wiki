...
A: For beginners, there may be some issues with setting it up. For this reason, we have [created detailed documentation for flashing the firmware](../Firmware-Flash/flash-m8p-v2-ebb.mdx). You can refer to it, and if it doesn't work, you can contact us for assistance.
