...
In order to install the 9mm belt, the carrier will be divided into two parts,and the large base part needs to be installed first.
Compared to the previous one, the center of gravity of the print head has basically not been generated.
Also can work with most probes like klicky, beacon, Bltouch.
![image-20231029223829165](https://img.mpx.wiki/i/2024/02/05/65c0b36dbaff3.webp)
