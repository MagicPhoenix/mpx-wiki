...
<Callout type="info">
We strongly recommend flashing the Manta M8P and the EBB SB2209 boards before installing them into the printer as detailed in the [Firmware Flashing Guide](../Firmware-Flash/flash-m8p-v2-ebb.mdx)
</Callout>
